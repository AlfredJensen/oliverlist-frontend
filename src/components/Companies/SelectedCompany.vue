    ...
    <main class v-if="!loading">
      <ol class="breadcrumb">
        <li
          ...
          @click="changeTab('ALL')"
        >{{ $t('lang.label.companies') }}</li>
        <!-- <li class="breadcrumb-item active">{{ selected.contact.name }}</li> -->
        <li class="breadcrumb-item active">{{ selected.name }}</li>
      </ol>
            ...
            <div class="col-12">
              <div class="card business rounded">
                ...
                <div class="card-body pxmax-4">
                  ...
                  <div>
                    <!-- <span class="badge mr-2"  :class="statusBadge(business.employers)">{{business.employers + ' Employers'}}</span> -->
                    <span
                      class="badge"
                  ...
                  <ul class>
                    <li v-for="(collegue ,key) in selectedbusiness.contacts" :key="key" class="p-4">
                      <div class="d-flex align-items-center">
                        ...
                        <div>
                          <!-- <strong>{{collegue.first_name + ' '+ collegue.last_name}}</strong> -->
                          <strong>{{ checkName(collegue.first_name + ' '+ collegue.last_name)}}</strong>
    ...
    changeTab(selectedTab) {
     ...
     convertType(value){
         ...
         loadMap(){
            ...
            let caracter='"';
            let url = "https://maps.google.com/maps?q="+"%2B"+latDMS[0]+"%C2%B0+"+latDMS[1]+"+"+latDMS[2]+",+"+lonDMS[0]+"%C2%B0+"+lonDMS[1]+"+"+lonDMS[2]+""+"&hl=es&z=14&amp;output=embed"
